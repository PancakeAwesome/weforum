	...
	<div class="container">
		<div class="header">
		    <div class="back" style="width:22px;">
		        <a style="display:block;" class="back-bt" href="index.html"></a>
		    </div>
		    <div class="theme">
		        <a class="th" href="index.html">宝宝粉</a>
		    </div>
		    <div class="cf">
		    </div>
		</div>
		<div class="item" style="margin-top: 50px;">
			<div class="headImg">
				<img src="http://i.pengxun.cn/thumb/articles/20160321/131030195568079778@200x200.jpg" class="headImg">	
			</div>
			<div class="title">
				<span class="name">管超</span>
				<div class="level">V.1</div><br>
				<span class="date">5-30</span>
				<span class="visited">浏览1980</span>
			</div>
			<img src="./images/post-big1_11.jpg" alt="" class="modify">
			<div class="content">
				<h4>title</h4>
				<p>发生的发生地方撒地方撒的 阿斯顿撒地方阿斯顿发生啊撒地方撒地方十大发生地方阿斯顿发生地方阿斯顿发生的发生的发生的发生的fads发生的</p>
			</div>
			<div class="hasmanage">
				<div>
					<input type="button" value="赞赏" class="button award">
				</div>
				<div>
					<span>共1人，1次赞赏</span>
				</div>
				<div class="awardPeople">
					<img src="http://wx.qlogo.cn/mmopen/Q3auHgzwzM5XPjLAjOicszqfa6QXovbwpzW1rKTkOZMefejNelBVBEjDdfANVhSmCUE1jEe9la6FFt2hBYsp0DMQNamSmpAYoJRXmvNoxt2g/132" alt="">
				</div>
			</div>
		</div>
		<div class="remark-fr">
		...
		<div id="textbox-replay" >
	        ...
	        <div class="post-ping-kuang rel">
	            ...
	            <ul class="post-wrap-pic-select clearfix bz" id="imgList" style="display:none;">
	                <li class="fl rel temp-upload-img" id="btn-addimg" style="cursor:pointer;width:18%;"><img src="http://i.pengxun.cn/content/images/imgpost2/success-select-column-close-add02.png" style="width:100%;"></li>
	            </ul>
	            <!--评论输入框-->
	            <div class="post-ping-kuang-bottom-content bz">
	                ...
	                <div class="bt-list">
	                    ...
	                    <div class="facepic">
	                    	<img src="images/post-big2_10.jpg" alt="" class="face">
	                    	<img src="images/post-big2_10.jpg" alt="" class="pic">
	                    </div>
	                </div>
	            </div>
	        </div>
		...
		<div class="footer">
			...
			<div class="like" replace='./images/zaned.png'>
				<img src="./images/icon1_10.png">
				<span>赞</span>
			</div>
			<div class="cf"></div>
		</div>
		<!-- 侧边栏 -->
		<div class="float-right-box" style="display:none">
			<a style="color:white;margin-left: 2px;padding: 4px 12px 0 7px;display:block;" href="index.html" class="home">
				<i class="homeicon"></i>
			</a>
