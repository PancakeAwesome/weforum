...
<ul class="content-wrap">
	...
	<li class="listborder">
		<ul class="mypost list clearfix">
			...
			<li style="margin-left: 5px;"><a href="/bbs/index.php/Mobile/Access/postList/user_id/1.html">TA的发帖</a></li>
		...
		<ul class="mypost list clearfix">
			...
			<li style="margin-left: 5px;"><a href="#">TA参与的</a></li>
			<li class="right"><span>0</span> <img src="images/icon1_13.png" alt="" onclick="#"></li>
		</ul>
	</li>
	<li class="listborder">
		<ul class="mypost list clearfix">
			...
			<li style="margin-left: 5px;"><a href="/bbs/index.php/Mobile/message/messagePerSend/user_id/1.html">发送私聊</a></li>
			<li class="right"><span>0</span> <img src="images/icon1_13.png" alt="" onclick="#"></li>
		</ul>
	</li>
	<li class="listborder">
		<ul class="mypost list clearfix">
			...
			<li style="margin-left: 5px;"><a href="#">关于我们</a></li>
			<li class="right"><span>0</span> <img src="images/icon1_13.png" alt="" onclick="#"></li>
		</ul>
	</li>
</ul>
